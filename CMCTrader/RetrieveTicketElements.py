...
def retrieveTicketElements(driver, pair):
	...
	return driver.execute_script(
			...
			'elem_order_type_entry = ticket_elements[\'TICKET\'].querySelector(\'[class="order-type"]\');'
			'ticket_elements[\'ORDER_TYPE_ENTRY\'] = elem_order_type_entry;'
			'elem_market = elem_order_type_entry.querySelector(\'[data-value="MARKET"]\');'
			'ticket_elements[\'MARKET\'] = elem_market;'
			'elem_limit = elem_order_type_entry.querySelector(\'[data-value="LIMIT"]\');'
			'ticket_elements[\'LIMIT\'] = elem_limit;'
			'elem_stop_entry = elem_order_type_entry.querySelector(\'[data-value="STOP_ENTRY"]\');'
			'ticket_elements[\'STOP_ENTRY\'] = elem_stop_entry;'
			'elem_order_type_stop = ticket_elements[\'TICKET\'].querySelector(\'div[class="stopLoss"]\').querySelector(\'[class="order-type"]\');'
